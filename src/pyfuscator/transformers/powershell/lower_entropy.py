...
class LowerEntropy(Transformer):
    ...
    def _substitute_aliases(self, text: str) -> str:
        ...
        substitutions = {
            ...
            r'\bGet-Content\b': 'gc',
            r'\bSet-Content\b': 'sc',
            r'\bGet-ChildItem\b': 'gci',
            r'\bGet-ChildItem\b': 'dir',
            r'\bGet-ChildItem\b': 'ls',
            r'\bWrite-Output\b': 'echo',
            r'\bWrite-Output\b': 'write',
            r'\bForEach-Object\b': '%',
            r'\bWhere-Object\b': '?',
            ...
            r'\bSet-Location\b': 'cd',
            r'\bSet-Location\b': 'sl',
            r'\bGet-Location\b': 'pwd',
            r'\bGet-Location\b': 'gl',
            r'\bCopy-Item\b': 'copy',
            r'\bCopy-Item\b': 'cp',
            r'\bCopy-Item\b': 'cpi',
            r'\bMove-Item\b': 'move',
            r'\bMove-Item\b': 'mv',
            r'\bMove-Item\b': 'mi',
            r'\bRemove-Item\b': 'del',
            r'\bRemove-Item\b': 'erase',
            r'\bRemove-Item\b': 'rd',
            r'\bRemove-Item\b': 'ri',
            r'\bRemove-Item\b': 'rm',
            r'\bRename-Item\b': 'ren',
            r'\bRename-Item\b': 'rni',
            r'\bTest-Path\b': 'test',
            ...
            r'\bNew-Item\b': 'ni',
            r'\bAdd-Content\b': 'ac',
            r'\bGet-History\b': 'history',
            r'\bGet-History\b': 'ghy',
            ...
            r'\bCompare-Object\b': 'compare',
            r'\bCompare-Object\b': 'diff',
            ...
            r'\bStart-Process\b': 'saps',
            r'\bStart-Process\b': 'start',
            r'\bStart-Service\b': 'sasv',
            r'\bStop-Process\b': 'spps',
            r'\bStop-Process\b': 'kill',
            r'\bStop-Service\b': 'spsv',
            r'\bWait-Process\b': 'wait',
            r'\bClear-Host\b': 'cls',
            r'\bClear-Host\b': 'clear'
        }
